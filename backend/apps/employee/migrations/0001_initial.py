    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('beginning', models.DateField(blank=True, null=True, verbose_name='Начало учебы')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=127, verbose_name='Название навыка')),
            ],
        ),
        migrations.CreateModel(
            name='Employee',
            fields=[
                ...
                ('education', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='employee.education', verbose_name='Университет')),
                ...
                ('subordinates', models.ManyToManyField(blank=True, related_name='superiors', to='employee.employee', verbose_name='Подчиненные')),
            ],
        ),
    ]
